...
┌─────────────────────────────────────────────────────────────────┐
│                                                                 │
│   UNSTRUCTURED SPARSITY              STRUCTURED 2:4 SPARSITY   │
│                                                                 │
│   [a . . b . c . . d .]              [a . b .][c . . d][. e f .]│
│    ↑   ↑     ↑   ↑ ↑                  └──┬──┘ └──┬──┘ └──┬──┘   │
│    Random positions                   Fixed pattern per group   │
│                                                                 │
│   Problems:                          Benefits:                  │
│   • Irregular memory access          • Predictable access       │
│   • Load imbalance across cores      • Perfect load balance     │
│   • Branch divergence                • No branching             │
│   • Index storage overhead           • Compressed indices       │
│                                                                 │
│   Speedup: need >90% sparsity        Speedup: 2× at 50%        │
│   for modest gains                   (hardware-accelerated)     │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
│  ■   ■   ○   ○   ○   ○   ○   ○   ○   ○   ○   ○   ■   ■   ○   ○ │
│                                                                 │
│  ■ = active (top-2)              ■ = active (top-2)            │
│  ○ = skipped                     ○ = skipped                   │
│                                                                 │
│  Language tokens → language experts    Math → math experts     │
│                                                                 │
│  Result: 8× capacity, only 2× compute (75% params skipped!)   │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
