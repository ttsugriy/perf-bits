...
> **For the best reading experience with properly rendered equations, [view this article on GitHub Pages](https://ttsugriy.github.io/perf-bits/symmetry.html).**
...
A convolution ties weights together. The kernel has k² · Cᵢₙ · Cₒᵤₜ parameters, regardless of spatial size.

| Layer Type | Parameters | For 224×224×3 → 64 |
|------------|-----------|-------------------|
| Fully connected | H · W · Cᵢₙ · Cₒᵤₜ | 9,633,792 |
| 3×3 Convolution | k² · Cᵢₙ · Cₒᵤₜ | 1,728 |
| 7×7 Convolution | k² · Cᵢₙ · Cₒᵤₜ | 9,408 |
...
where π is any permutation of node labels.

This forces the message-passing structure:

**hᵥ⁽ᵗ⁺¹⁾ = UPDATE(hᵥ⁽ᵗ⁾, AGG({hᵤ⁽ᵗ⁾ : u ∈ N(v)}))**
...
|----------|-----------|---------------------|---------|
| Translation (2D) | H × W | ~1000-10000× | CNNs |
...
This connects directly to the [commutativity article](https://ttsugriy.github.io/perf-bits/commutativity.html). Transformers need positional encodings *because* attention is commutative (permutation-equivariant). The architecture has too much symmetry for the task; we break it explicitly.
...
**Symmetry in data ⟹ Constraints on function ⟹ Weight sharing ⟹ Efficiency**
...
*Previous article: [Separability: The Art of Factorization](https://ttsugriy.github.io/perf-bits/separability.html)*
